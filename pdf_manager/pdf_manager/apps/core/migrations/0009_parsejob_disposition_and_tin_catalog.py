...
def revert_drake_template(apps, schema_editor):
    Template = apps.get_model("core", "Template")
    Template.objects.filter(name="DRAKE", version="1").update(
        rules_json={
            "schema_version": 1,
            "field_catalog": [
                {"key": "taxpayer_first_name", "tier": "A", "source_roles": ["extract_client_letter"]},
...
class Migration(migrations.Migration):
    dependencies = [
        ("core", "0008_phase5_extracted_field_lineage"),
    ]

    operations = [
        migrations.RunPython(update_drake_template, revert_drake_template),
    ]
